...
bind('n', '<F5>', '<cmd>lua vim.lsp.buf.signature_help()<cr>', noremap)

-- bind('n', '<leader>do', '<cmd>lua vim.diagnostic.open_float()<cr>', noremap)
bind('n', '<F8>', '<cmd>lua vim.diagnostic.goto_prev()<cr>', noremap)
bind('n', '<F7>', '<cmd>lua vim.diagnostic.goto_next()<cr>', noremap)
